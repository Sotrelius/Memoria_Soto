...
scatter(Sd,n, 110, 'o', 'DisplayName', ' 27 [Pa]');
%boxplot(n,Sd);
hold on
scatter(Sd5,n5, 210, 's',  'DisplayName', '274 [Pa]');
%boxplot(n5,Sd5);
scatter(Sd50,n50, 110, 'o', 'DisplayName', '2743 [Pa]');
scatter(Sd100,n100, 110, 'o', 'DisplayName', '5486 [Pa]');
scatter(Sd500,n500, 110, 'o',  'DisplayName', '27430 [Pa]');
%scatter(Sd1000,n1000, 100, 'DisplayName', '54860 [Pa]');
%scatter(Sd2000,n2000, 100, 'DisplayName', '109720 [Pa]');
hold on
hold off
