...
scatter(Sd,d85, 110, 'o', 'DisplayName', ' 27 [Pa]');
%boxplot(n,Sd);
hold on
scatter(Sd5,d855, 210, 's',  'DisplayName', '274 [Pa]');
%boxplot(n5,Sd5);
scatter(Sd50,d8550, 110, 'o', 'DisplayName', '2743 [Pa]');
scatter(Sd100,d85100, 110, 'o', 'DisplayName', '5486 [Pa]');
scatter(Sd500,d85500, 110, 'o',  'DisplayName', '27430 [Pa]');
hold on
hold off
