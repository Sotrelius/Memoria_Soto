#**********************************************************************
#Cuadrilatero con agua, cualcula modulos de fuerzas (promedio)
...
rmean=0.003
D=rmean*30   #*50 lo disminui para corre
h=rmean*48   #*80 the same shit
R1=3
load=5e1
fecha="21/07/2015"
