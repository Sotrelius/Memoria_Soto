...
for i in range(0, n1):
    ...
    file = open("/home/diego/memoria/YADE/Codigos/PSDBimodal/granulometryP3b", "a")
    file.write(result)
    file.close()
...
#         despRest[cant3]=deltaScalar
    ...
    plot.addData(dmf=despMeanFino, dMaxf=despMaxFino, dMaxAcumf=despAcumMaxFino,dmg=despMeanGros, dMaxg=despMaxGros, dMaxAcumg=despAcumMaxGros, i=__builtin__.time1, i1=__builtin__.time1 , i2=O.iter, ic=__builtin__.icr, ii=it)
    cant1=0
    cant2=0
    cant3=0
...
plot.plots={'i':('dMaxf', 'dmf', 'dMaxAcumf','dMaxg','dMaxAcumg'), 'i1':('ic', 'ii') }
plot.plot()
O.run()
