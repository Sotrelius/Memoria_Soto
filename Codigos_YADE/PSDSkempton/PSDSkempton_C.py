...
psdSizes=[2e-4, 4e-4, 6e-4, 8e-4, 2e-3, 3e-3 , 6e-3, 7.5e-3]
psdCumm=[0.0, 0.05, 0.095, 0.16, 0.22, 0.32, 0.88 , 1.]
...
for i in range(0, n1):
    ...
    file = open("/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_C1", "a")
    file.write(result)
    file.close()
...
def parar():
   ...
   if abs(carga)>1.03*load:
    ...
    O.save('/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_C/C3_conf.bz2')
    O.run()
    muro.dead=1
##########################################################################
...
def TensionesR():
   ...
   for i in range(6, n1+6):
        ...
        ruta2="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_C/tension_P"+repr(N)
        file = open(ruta2, "a")
        file.write(result)
        file.close()
   O.run()
...
def perfilVertTens():
    ...
    N=O.iter
    ruta="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_C/perfil_"+repr(N)
...
VTKRecorder(dead=1, fileName='/home/diego/memoria/YADE/video_C/gran_C-vtk-',recorders=['all'],iterPeriod=1500, label="SaveEsf"),
]
