...
for i in range(0, n1):
    ...
    file = open("/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_D1", "a")
    file.write(result)
    file.close()
...
def TensionesR():
   ...
   for i in range(6, n1+6):
        ...
        ruta2="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_D/tension_P"+repr(N)
        file = open(ruta2, "a")
        file.write(result)
        file.close()
   O.run()
...
#VTKRecorder(dead=0, fileName='/home/diego/memoria/YADE/video_C/gran_C-vtk-',recorders=['all'],iterPeriod=1500, label="SaveEsf"),
]
