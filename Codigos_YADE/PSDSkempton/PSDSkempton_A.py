...
for i in range(0, n1):
    ...
    file = open("/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_A1", "a")
    file.write(result)
    file.close()
...
def parar():
   ...
   if abs(carga)>1.03*load:
    ...
    O.save('/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_A/A3_conf.bz2')
    O.run()
    muro.dead=1
##########################################################################
...
def TensionesR():
   ...
   for i in range(6, n1+6):
        ...
        ruta2="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_A/tension_P"+repr(N)
        file = open(ruta2, "a")
        file.write(result)
        file.close()
   O.run()
...
def perfilVertTens():
    ...
    N=O.iter
    ruta="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_A/perfil_"+repr(N)
