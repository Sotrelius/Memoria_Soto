...
#    file = open("/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_B1", "a")
#    file.write(result)
#    file.close()
...
#    O.save('/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_B/B3_conf.bz2')
#    O.run()
#    muro.dead=1
##########################################################################
...
def TensionesR():
   ...
   for i in range(6, n1+6):
        ...
        ruta2="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_B/tension_P"+repr(N)
        file = open(ruta2, "a")
        file.write(result)
        file.close()
   O.run()
