...
psdSizes=[1e-3, 3e-3 , 5e-3, 8.e-3]
psdCumm=[0.0, 0.2, 0.8 , 1.]
...
sph1.makeCloud(mn,mx1,-1,0,num_spheres,False, 0.55,psdSizes,psdCumm,True,seed=1)
...
###################################################################
#H2=0.03
#mn2,mx2=Vector3(0,0,H2-.90/64*.15),Vector3(D,D,H2)
#psdSizes2=[1.5e-4, 2e-4 , 3e-4]
#psdCumm2=[0.0, 0.8 , 1.]
#sph2=pack.SpherePack()
#sph2.makeCloud(mn2,mx2,-1,0,num_spheres,False, 0.85,psdSizes2,psdCumm2,True,seed=1)
#sph2.toSimulation(material='sph')
##n1=len(sph1)+len(sph2)
##################################################################
##################################################################
...
for i in range(0, n1):
    ...
    file = open("/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_G1", "a")
    file.write(result)
    file.close()
...
def parar():
   ...
   if abs(carga)>1.03*load:
    ...
    O.save('/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_G/G_conf.bz2')
    O.run()
    muro.dead=1
##########################################################################
...
def TensionesR():
   ...
   for i in range(6, n1+6):
        ...
        ruta2="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_G/tension_P"+repr(N)
        file = open(ruta2, "a")
        file.write(result)
        file.close()
   O.run()
...
def perfilVertTens():
    ...
    N=O.iter
    ruta="/home/diego/memoria/YADE/Codigos/PSDSkempton/granSkempton_B/perfil_"+repr(N)
