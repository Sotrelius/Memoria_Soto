...
psdSizes=[3e-4, 1e-3, 2e-3, 4e-3, 1e-2, 2e-2 , 4e-2]
psdCumm=[0.0, 0.2, 0.3, 0.4, 0.5, 0.7 , 1.]
...
sph1.makeCloud(mn,mx,-1,0,num_spherehttps://account.live.com/SummaryPage.aspxs,False, 0.65,psdSizes,psdCumm,True,seed=1)
