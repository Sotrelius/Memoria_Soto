...
"def parar():\n"
"   poros=flow.porosity\n"
"   O.bodies[5].state.vel[2]=-"+repr(Vel*.1)+" #agilizando la cosa\n"
"   O.pause()\n"
"   flow.dead=0\n"
...
inputs = [ ('Sotrero', 1, Vel, 0.17, np, Pi), ('Hamilton', 2, Vel, 0.34, np, Pi)]#, ('verstapen', 3, Vel, 0.34, np, Pi), ('Skt1MPhelps', 4, Vel, 0.51, np, Pi ), ('UsainBolt', 5, Vel, 0.68, np,Pi)]
