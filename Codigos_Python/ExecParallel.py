...
def each_call(input_params):
    ...
    command_name = ' echo $PWD && cd myYade/trunk/bins/  && ./yade-1.14.0 /home/diego/memoria/YADE/Codigos/PsdVarPRF.py && pwd && cd .. $$ cd .. $$'   # Change for whatever commnad you need to call
...
inputs = [ ('Diego', 1), ('Gerardo', 2), ('Edy', 3), ('Cristian', 4)]
